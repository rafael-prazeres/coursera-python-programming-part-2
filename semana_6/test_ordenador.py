...
class TestaOrdenador:
    ...
    def l_quase(self):
        ...
        return c.lista_quase_ordenada(20)

    @pytest.fixture
    def l_aleatoria(self):
        c = conta_tempos.ContaTempos()
        return c.lista_aleatoria(10)
    ...
    def test_merge_sort_l_aleatoria(self, o, l_aleatoria):
        lista = o.merge_sort(l_aleatoria)
        assert o.sequencia_ordenada(lista) == True

    def test_merge_sort_l_quase(self, o, l_quase):
        lista = o.merge_sort(l_quase)
        assert o.sequencia_ordenada(lista)  == True
